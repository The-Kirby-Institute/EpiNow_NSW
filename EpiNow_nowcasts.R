...
reported_cases <- GetCases(nsw_raw_cases, dataOption, regionLevel, startDate, 
...
estimates <- epiFunction(reported_cases = reported_cases, 
...
if (regionalRun) {
  ...
  results_dir = file.path("results", resultsFolder)
  target_date = "latest"
  summary_dir =  file.path(results_dir, "summary", "latest")
  ...
  # timeseries <- EpiNow2::get_regional_results(regional_output = NULL,
  #   results_dir = results_dir,
  #   date = target_date,
  #   samples = FALSE,
  #   forecast = FALSE)
